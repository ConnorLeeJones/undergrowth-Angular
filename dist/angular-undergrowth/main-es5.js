...
var HomescreenComponent = /** @class */ (function () {
    function HomescreenComponent(router) {
        this.router = router;
    ...
    HomescreenComponent.prototype.ngOnChanges = function (changes) {
    };
    HomescreenComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var SearchResultsComponent = /** @class */ (function () {
    function SearchResultsComponent(searcher) {
...
var SearcherComponent = /** @class */ (function () {
    function SearcherComponent(profileService, router) {
    ...
    SearcherComponent.prototype.onSubmit = function () {
        var _this = this;
        // let currentUser = JSON.parse(localStorage.getItem('currentUser'));
        // this.searchCriteria.zipcode = currentUser.userProfile.zipcode;
        console.log(this.searchCriteria);
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        this.profileService.getProfile().subscribe(function (profile) { return _this.currentUserProfile = profile; });
    ...
    SearcherComponent.ctorParameters = function () { return [
        { type: _services_profile_service__WEBPACK_IMPORTED_MODULE_4__["ProfileService"] },
...
var ProfileService = /** @class */ (function () {
    function ProfileService(http, router, userService, loginService) {
        this.http = http;
        this.router = router;
    ...
    ProfileService.prototype.editProfile = function (userProfile, id) {
        console.log(this.currentUser);
        this.http.put(this.url + '/' + id, userProfile).subscribe();
        // this.loginService.login(this.currentUser);
    };
    ProfileService.prototype.findLocalProfiles = function (type, profile) {
    ...
    ProfileService.prototype.findAllProfiles = function (type) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.addUser = function (user) {
        var _this = this;
        this.http.post(this.url, user).subscribe(function (user) {
    ...
    UserService.prototype.userLogin = function (user) {
        ...
        this.currentUser = null;
        this.loginService.login(user).subscribe(function (user) {
            _this.currentUser = user;
            _this.currentUser.password = null;
            _this.currentUserProfile = _this.currentUser.userProfile;
            console.log(_this.currentUserProfile);
...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(service, http, router) {
        this.service = service;
        this.http = http;
        this.router = router;
...
var TypeSelectorComponent = /** @class */ (function () {
...
var UserLoginComponent = /** @class */ (function () {
    function UserLoginComponent(service, http, router) {
        this.service = service;
        this.http = http;
        this.router = router;
...
var UserProfileComponent = /** @class */ (function () {
    ...
    UserProfileComponent.prototype.getProfile = function () {
        ...
        this.userService.getUserById(id).subscribe(function (currentUser) {
            _this.user = currentUser;
            _this.profile = _this.user.userProfile;
            if (_this.currentUser.id === _this.user.id) {
                _this.show = true;
            }
        });
    };
